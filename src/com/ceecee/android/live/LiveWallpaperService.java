...
// Change the petals to move along the axes of the accelerometer
	...
	public ParticleSystem createParticleSystem(final TextureRegion mFlowerTextureRegion)
	{
...
//Set a variable for the max particles in the system.
		...
		final PointParticleEmitter pointParticleEmitter = new PointParticleEmitter(mParticleX, mParticleY);
	
		final BatchedSpriteParticleSystem particleSystem = new BatchedSpriteParticleSystem
				(pointParticleEmitter, mParticleMinRate, mParticleMaxRate, mParticleMax,
